...
import PlaceholderImage from '../assets/headshot.JPG';

// Replace these variables with your information
const firstName = 'Sarah';
const jobTitle = 'FullStack Developer and Software QA Engineer';
const company = 'Google';
const mainDuty = 'Quality Assurance';
const jobLocation = 'NY, New York';
const briefJobDescription = 'I focus on executing best practices in software test case development and requirement analysis.';
const careerObjective = 'My objective is to obtain an exciting and rewarding position in a dynamic organization where I can utilize my skills and experience to contribute to the growth and success of the company.';
